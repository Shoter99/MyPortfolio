...
<div className="text-neutral-200 md:w-[60%] md:m-10 border-neutral-200 md:p-8 p-2 mt-4 rounded border-2 overflow-auto">
    <h2 className="md:text-3xl ">Hi!</h2>
        ...
        started with
        <span className="text-orange-400"> C++</span> then I learned basics
        of
        ...
        <span className="text-orange-400"> PHP</span>. After these I
        switched to
        <span className="text-orange-400"> Python</span> and learned
        language and frameworks like
        <span className="text-orange-400"> Flask</span> and
        <span className="text-orange-400"> Django</span>. I also took part
        in a few game jams and used engines like
