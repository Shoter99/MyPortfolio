...
const ProjectCard = (props: Props) => {
  return (
    <div data-aos={props.index % 2 === 0 ? "fade-right" : "fade-left"} className="border border-neutral-700 rounded shadow-2xl flex flex-col md:flex-row justify-between md:items-center  text-neutral-200 bg-neutral-700">
      ...
      <div className="py-5 md:mt-0 px-10 w-96">
